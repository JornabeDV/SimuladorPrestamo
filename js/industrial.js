// LocalStorage dura hasta que lo borremos.

localStorage.setItem("capital", "value")

// SessionStorage dura hasta que cerremos la pestaña.
...
miPrestamo.addEventListener("click", calcularPrestamoIndustrial);


//Establezco el diseño de la function que calcula los préstamos Industriales.

function calcularPrestamoIndustrial() {
    ...
    if( n,n2,n3 >0 & n2<120) {   //Condiciones
        ...
        alert("El máximo disponible de cuotas para Préstamos Industriales es de 120 periodos");
    }
