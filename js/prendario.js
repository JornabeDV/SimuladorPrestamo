...
miPrestamo.addEventListener("click", calcularPrestamoPrendario);


//Establezco el diseño de la function que calcula los préstamos Prendarios.

function calcularPrestamoPrendario() {
    ...
    if( n,n2,n3 >0 & n2<60) {   //Condiciones
        ...
        alert("El máximo disponible de cuotas para Préstamos Prendarios es de 60 periodos");
    }
