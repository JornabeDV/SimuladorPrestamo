...
miPrestamo.addEventListener("click", calcularPrestamoHipotecario);


//Establezco el diseño de la function que calcula los préstamos Hipotecarios.

function calcularPrestamoHipotecario() {
    ...
    if( n,n2,n3 >0 & n2<240) {   //Condiciones
        ...
        alert("El máximo disponible de cuotas para Préstamos Hipotecarios es de 240 periodos");
    }
