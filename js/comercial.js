...
miPrestamo.addEventListener("click", calcularPrestamoComercial);
...
function calcularPrestamoComercial() {
    ...
    console.log(n|| "Falta Capital");
    console.log(n2|| "Falta Número de Cuotas");
    console.log(n3|| "Falta tasa de interes");
